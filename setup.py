...
shutil.copy(os.path.join('src','docs.py'), '.')  # Hack! Why does this import *not* work when cd'ing into src?
import docs  # And why *does* this relative import work at all with python >= 3?
os.remove('docs.py')
